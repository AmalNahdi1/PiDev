...
public class client {
    ...
    public client(int id_client, int cin_client, String nom_client, String prenom_client, String ville_client,
            int telephone_client, String email_client, String mdp_client, boolean role) {
